...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('differential_focus', function (Blueprint $table) {
            ...
            $table->enum('grupo_etnico', ['Negro', 'Afrocolombiano', 'Raizal', 'Palenquero', 'Otro', 'Ninguno'])->default('Ninguno');
    ...
    {
        Schema::dropIfExists('differential_focus');
    }
};
